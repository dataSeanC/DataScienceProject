...
terrorism <- read_xlsx(path = "C:/Users/PC - Main/Desktop/globalterrorismdb_0617dist.xlsx", col_types = "text") %>%
  select("Year" = iyear, 
         "Month" = imonth, 
         "Day" = iday, 
         "Country" = country_txt, 
...
## Of these...
...Which regions have which groups?
...
ggplot(count, 
  ...
  labs(subtitle = "with New York City",
       caption = "Source: GTD") +
  ggtitle("Terrorist Attacks in Top U.S. City") +
  theme_set(theme_bw()) +
